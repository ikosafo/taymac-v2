				...
				<div class="row gy-2 gx-4 gx-md-5">
					...
					<div class="border-start col-auto">
						<ol class="align-items-center breadcrumb fw-medium mb-0">
							...
							<li class="breadcrumb-item d-flex align-items-center active" aria-current="page">COSHH</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="about-text align-items-center g-4 justify-content-between row">
						...
						<div class="row g-3 g-sm-4 align-items-center">
							...
							<div class="col-12">
								<div class="row g-3 g-sm-4">
									<div class="col-12"> <img src="<?php echo URLROOT ?>assets/images/fm6.webp" class="img-fluid rounded-3" alt=""> </div>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-12 col-lg-7 ps-xxl-5">
						<div class="text-block">
							...
							<h4 class="mb-4">Control of Substances Hazardous to Health</h4>
                            <ul class="list-checked mb-9 mb-md-10 ps-0">
                                <li>COSHH Management</li>
                                <li>Suppliers of Personal Protective Equipment</li>
                                <li>Suppliers of Staff Uniforms, Coveralls, Overalls, etc</li>
                            </ul>
						</div>
					</div>
				</div>
