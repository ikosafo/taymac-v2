				...
				<div class="row gy-2 gx-4 gx-md-5">
					...
					<div class="border-start col-auto">
						<ol class="align-items-center breadcrumb fw-medium mb-0">
							...
							<li class="breadcrumb-item d-flex align-items-center active" aria-current="page">First Aid</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="about-text align-items-center g-4 justify-content-between row">
						...
						<div class="row g-3 g-sm-4 align-items-center">
							...
							<div class="col-12">
								<div class="row g-3 g-sm-4">
									<div class="col-12"> <img src="<?php echo URLROOT ?>assets/images/fm4.webp" class="img-fluid rounded-3" alt=""> </div>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-12 col-lg-7 ps-xxl-5">
						<div class="text-block">
                            ...
                            First Aid</h6>
							<h4 class="mb-4">Everyday Basic First Aid Awareness</h4>
