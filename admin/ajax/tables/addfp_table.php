...
$pinq = $mysqli->query("select * from taymac_fp ORDER BY id DESC");
?>
<style>
    .dataTables_filter {
        display: none;
                ...
                while ($fetch = $pinq->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button"
                                    data-type="confirm"
                                    class="btn btn-danger delete_fp"
...
<script>
    ...
    $(document).off('click', '.delete_fp').on('click', '.delete_fp', function () {
        var theindex = $(this).attr('i_index');
        //alert(theindex)
        $.confirm({
            title: 'Delete Featured Property!',
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajax/queries/delete_fp.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
