...
$pinq = $mysqli->query("select * from taymac_team ORDER BY id DESC");
?>
<style>
    .dataTables_filter {
        display: none;
                ...
                while ($fetch = $pinq->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button"
                                    data-type="confirm"
                                    class="btn btn-danger delete_team"
...
<script>
    ...
    $(document).off('click', '.delete_team').on('click', '.delete_team', function () {
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajax/queries/delete_team.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
