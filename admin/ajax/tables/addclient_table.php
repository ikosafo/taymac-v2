...
$pinq = $mysqli->query("select * from taymac_client_feedback ORDER BY id DESC");
?>
<style>
    .dataTables_filter {
        display: none;
            ...
            <table id="data-table" class="table" style="margin-top: 3% !important;">
                ...
                while ($fetch = $pinq->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $fetch['client_text']; ?></td>
                        <td>
                            <button type="button"
                                    data-type="confirm"
...
<script>
    ...
    $(document).off('click', '.delete_client').on('click', '.delete_client', function () {
        var theindex = $(this).attr('i_index');
        //alert(theindex)
        $.confirm({
            title: 'Delete Feedback Text!',
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajax/queries/delete_client.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
