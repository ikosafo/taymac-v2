...
$pinq = $mysqli->query("select * from farm_inputs ORDER BY id DESC");
?>
<style>
    .dataTables_filter {
        display: none;
        ...
        <div class="table-responsive">
            <table id="data-table" class="table" style="margin-top: 3% !important;">
                ...
                while ($fetch = $pinq->fetch_assoc()) {
                    ?>
                    <tr>
                        <td><?php echo $fetch['input_name']; ?></td>
                        <td><?php echo $inputtype = $fetch['input_type'];
                            if ($inputtype == "Other") {
                                echo $fetch['input_type_other'];
                            }
                            ?>
                        </td>
                        <td>
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajax/queries/delete_farminput.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
