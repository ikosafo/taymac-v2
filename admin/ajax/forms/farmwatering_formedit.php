...
$getwatering = $mysqli->query("select * from farm_watering where id = '$theindex'");
$reswatering= $getwatering->fetch_assoc();
?>
<!--begin::Form-->
        ...
        <div class="form-group row">
            <div class="col-lg-12 col-md-12">
                ...
                <select id="cycle" style="width: 100%">
                    ...
                    <option <?php if (@$reswatering['cycle'] == "First") echo "Selected" ?>>First</option>
                    <option <?php if (@$reswatering['cycle'] == "Second") echo "Selected" ?>>Second</option>
                    <option <?php if (@$reswatering['cycle'] == "Third") echo "Selected" ?>>Third</option>
                    <option <?php if (@$reswatering['cycle'] == "Fourth") echo "Selected" ?>>Fourth</option>
                </select>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            <div class="col-lg-6 col-md-6">
                ...
                <input type="text" class="form-control" id="time_start"
                       placeholder="Enter Start Time" value="<?php echo $reswatering['starttime'] ?>">
            </div>
            <div class="col-lg-6 col-md-6">
                <label for="time_end">Time End</label>
                <input type="text" class="form-control" id="time_end"
                       placeholder="Enter End Time" value="<?php echo $reswatering['endtime'] ?>">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-lg-6 col-md-6">
                ...
                <input type="text" class="form-control" id="input_kg"
                       ...
                       placeholder="Enter Amount" value="<?php echo $reswatering['input_kg'] ?>">
            </div>
            <div class="col-lg-6 col-md-6">
                <label for="input_g">Amount (in ml)</label>
                <input type="text" class="form-control" id="input_g"
                       onkeypress="return isNumberKey(event)" value="<?php echo $reswatering['input_g'] ?>"
        ...
        <div class="form-group row">
            <div class="col-lg-6 col-md-6">
                ...
                <input type="text" class="form-control" id="date_activity"
                       placeholder="Enter Date of Activity" value="<?php echo $reswatering['date_activity'] ?>">
            </div>
            <div class="col-lg-6 col-md-6">
                <label for="activity_description">Description</label>
                <textarea class="form-control" id="activity_description"
                          placeholder="Enter Description"><?php echo $reswatering['activity_description'] ?></textarea>
            </div>
        </div>
...
<script>
    ...
    $('#editactivity').click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/editform_farmwatering.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
