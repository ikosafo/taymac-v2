            ...
            <div class="row">
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 py-3 py-md-5 pe-xl-5">
                    <div class="footer-about">
                        ...
                        <a class="d-block fw-medium mb-1" href="#"><i class="fa-solid fa-phone me-2"></i>
                            <span>+233 (0) 245-710-614</span>
                        </a>
                        <a class="email-link d-block mb-1 fw-medium" href="mailto:info@taymac.net">
                            <i class="fa-solid fa-envelope me-2"></i>
                            <span>info@taymac.net</span>
                        </a>
                ...
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 py-3 py-md-5 pe-xl-5">
                    <div class="footer-about">
                        ...
                        <a class="d-block fw-medium mt-4">
                            ...
                            <span>Ground Floor Le Pierre, <br>
